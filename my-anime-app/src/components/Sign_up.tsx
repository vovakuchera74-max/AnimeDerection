      ...
      <div className={s.Sign_up_BOX}>
        <form className={s.Form} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={s.Inputt}>
            ...
            {errors.username && <span style={{color: '#ff6b6b', fontSize: '14px', fontWeight: "500",marginLeft: "6px"}}>{errors.username.message}</span>}
          </div>
          ...
          <div className={s.Inputt}>
            ...
            {errors.confirmPassword && <span style={{color: '#ff6b6b', fontSize: '14px', fontWeight: "500",marginLeft: "6px"}}>{errors.confirmPassword.message}</span>}
          </div>
